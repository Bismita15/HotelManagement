...
public class RequestLabTestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setForeground(new java.awt.Color(193, 243, 232));
        setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        requestTestJButton.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        requestTestJButton.setForeground(new java.awt.Color(0, 0, 0));
        requestTestJButton.setText("Request Test");
        requestTestJButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 89, -1));
